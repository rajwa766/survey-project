...
<input class="big-checkbox <?= $all_country->Country; ?>" type="checkbox" id="<?= $all_country->id; ?>">
   ...
   if(this.checked){
	        ...
	        $.ajax({
                ...
                success: function (test) {
									...
									if(radioValue == '1'){
										if(json.WIPO == '0'){
											$original_price = parseFloat(json.OfficialFee1) +  parseFloat(json.OurFeeSimple1) + parseFloat(json.AgentFee1);
									$hidden_price =  parseFloat(json.OfficialFee2plus) + parseFloat(json.OurFeeDetailed1) + parseFloat(json.AgentFee2plus);
										}else{
									$original_price = parseFloat(json.OfficialFee1) +  parseFloat(json.OfficialFee2plus) + parseFloat(json.OurFeeSimple1) + parseFloat(json.OurFeeSimple2plus)+ parseFloat(json.AgentFee1)+ parseFloat(json.AgentFee2plus);
									$hidden_price =  parseFloat(json.OfficialFee1) + parseFloat(json.OurFeeDetailed1) + parseFloat(json.AgentFee1);
										
										}
									$price = $original_price * $no_of_product;
									}else{
										if(json.WIPO == '0'){
											$hidden_price = parseFloat(json.OfficialFee1) +  parseFloat(json.OurFeeSimple1) + parseFloat(json.AgentFee1);
									$original_price =  parseFloat(json.OfficialFee2plus) + parseFloat(json.OurFeeDetailed1) + parseFloat(json.AgentFee2plus);
										}else{
									$hidden_price = parseFloat(json.OfficialFee1) +  parseFloat(json.OfficialFee2plus) + parseFloat(json.OurFeeSimple1) + parseFloat(json.OurFeeSimple2plus)+ parseFloat(json.AgentFee1)+ parseFloat(json.AgentFee2plus);
									$original_price =  parseFloat(json.OfficialFee1) + parseFloat(json.OurFeeDetailed1) + parseFloat(json.AgentFee1);
